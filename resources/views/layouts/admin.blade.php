    ...
    <div class="flex bg-gray-200">
        <nav class="bg-white shadow-sm w-56 py-16">
            ...
            <div class="flex flex-col justify-between">
                <a href="#" class="flex  items-center p-1 text-sm px-3  fade">
        ...
        <div class="flex p-2 flex-1">
            <main class="bg-white shadow-sm flex-1 mr-2 p-4 ">
                @yield('content')
            </main>
            <aside class="w-64 flex-col">
                ...
                <div class="bg-white mb-4  shadow-sm p-4 flex flex-col justify-center">
                    ...
                    <button class="bg-red-500  px-4 py-2 outline-none text-sm capitalize text-white font-bold">Add new entity</button>
                </div>
