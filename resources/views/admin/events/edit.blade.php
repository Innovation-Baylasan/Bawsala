    ...
    <form method="POST" action="{{ route('events.update', $event->id)  }}" enctype="multipart/form-data">
        ...
        <select id="entity" name="entity_id">
            @foreach($entities as $entity)
                <option @if($entity->id == $event->entity->id) selected
                        @endif value="{{ $entity->id  }}">{{ $entity->name }}</option>
            @endforeach
        </select>
        ...
        <input type="date" id="application_start_datetime" name="application_start_datetime"
               value="{{ $event->application_start_datetime  }}">
        ...
        <input type="date" id="application_end_datetime" name="application_end_datetime"
               value="{{ $event->application_end_datetime  }}">
