...
<div id="app" class="theme-light">
    <div class="flex flex-1 h-full bg-gray-200">
        <nav class="bg-default fixed inset-0 shadow-sm w-56 pt-16 pb-2">
            <div class="flex flex-col items-center mb-12 h-full">
                ...
                <div class="flex flex-col ">
                    ...
                    <a href="/admin/settings" class="flex  items-center p-1 text-sm px-3  fade">
                        <div class="w-10 h-10 flex items-center justify-center  mr-4">
                            <img src="{{asset('svg/tags-icon.svg')}}" alt="">
                        </div>
        ...
        <div class="pl-56 flex-1">
            <main class="p-4 pb-0 flex">
                <div class="bg-default flex-1 shadow-sm  mr-2">
                    {{$slot}}
                </div>
                <div class="flex-col">
